...
const btnPrimary =
  "inline-flex min-h-[44px] w-full items-center justify-center rounded-[4px] bg-[#C8922A] px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-[#b07f22] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#C8922A] focus-visible:ring-offset-2 focus-visible:ring-offset-[#1A3A5C] sm:w-auto";
const btnSecondary =
  "inline-flex min-h-[44px] w-full items-center justify-center rounded-[4px] border border-white/35 bg-white/5 px-5 py-2.5 text-sm font-semibold text-white backdrop-blur-sm transition hover:bg-white/12 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#1A3A5C] sm:w-auto";
const btnGhost =
...
export function CookieBanner() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl overflow-hidden rounded-[8px] border border-[#D0DCE8]/25 bg-[#1A3A5C] shadow-[0_12px_40px_rgba(0,0,0,0.28)]">
        {/* Gold accent bar */}
        <div className="h-1 bg-gradient-to-r from-[#C8922A] via-[#1A3A5C] to-[#C8922A]" aria-hidden />
