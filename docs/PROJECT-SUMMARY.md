...
AfricaExpertWitness.com is a **lead-generation website** for UK immigration solicitors, law firms, and international arbitration counsel who need **Africa expert reports**. It targets three markets:
...
**Primary SEO goal:** Rank #1 for “Africa expert report” and related country/region-specific queries.
...
| Token | Hex | Use |
|-------|-----|-----|
| Primary (forest green) | `#0C3547` | Header, heroes, headings |
| Accent (gold) | `#C8922A` | CTAs, highlights |
| Background | `#FFFFFF` | Page background |
| Section alt | `#F4F8F7` | Alternating sections |
| Border | `#C8DDD6` | Cards, inputs |
