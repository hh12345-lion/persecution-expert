  ...
  return (
    <>
      ...
      <PageShell title="Cookie Policy" subtitle="Last updated: May 2026" breadcrumbs={crumbs}>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0c1218]">What are cookies?</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0c1218]">How we use cookies</h2>
        <ul className="mt-4 list-disc space-y-2 pl-6 text-[#3a4550]">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0c1218]">Cookie categories</h2>
          ...
          {(Object.keys(CATEGORY_META) as Array<keyof typeof CATEGORY_META>).map((key) => {
            ...
            return (
              <section key={key} className="rounded-[8px] border border-[#C8DDD6] p-4">
                <h3 className="font-semibold text-[#0c1218]">{meta.label}</h3>
                <p className="mt-2 text-sm text-[#3a4550]">{meta.description}</p>
                {meta.required && (
                  <p className="mt-2 text-xs font-medium text-[#0c1218]">Always active</p>
                )}
              </section>
            );
          })}
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0c1218]">Third-party services</h2>
        <p className="mt-4 text-[#3a4550] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0c1218]">Browser controls</h2>
        <p className="mt-4 text-[#3a4550] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0c1218]">Contact</h2>
        <p className="mt-4 text-[#3a4550] leading-relaxed">
          Questions about this policy:{" "}
          <a href={`mailto:${SITE_EMAIL}`} className="text-[#d66a3a] hover:underline">
            {SITE_EMAIL}
          </a>
        </p>
      </PageShell>
