  ...
  return [
    {
      ...
      load: () => {
        ...
        injectScript("per-gtag-js", `https://www.googletagmanager.com/gtag/js?id=${gaId}`);
        const inline = document.createElement("script");
        inline.id = "per-gtag-inline";
        inline.textContent = `
      ...
      unload: () => {
        removeScript("per-gtag-js");
        removeInlineScript("per-gtag-inline");
    ...
    },
    {
      ...
      unload: () => {
        removeInlineScript("per-gtm-inline");
        removeScript(`per-gtm-external-${gtmId}`);
    ...
    },
    {
      ...
      unload: () => {
        removeInlineScript("per-meta-pixel");
    ...
    },
    {
      ...
      load: () => {
        ...
        const inline = document.createElement("script");
        inline.id = "per-linkedin-insight";
        inline.textContent = `
      ...
      unload: () => {
        removeInlineScript("per-linkedin-insight");
        removeScript("per-linkedin-js");
